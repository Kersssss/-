...
profit=int(input('Show me the money: '))            #将需要计算的金额数赋值给变量
bonus=0                                             #最后输出的数值初始为0
thresholds=[100000,100000,200000,200000,400000]     #不同的提成分级列成列表
rates=[0.1,0.075,0.05,0.03,0.015,0.01]              #不同的提成列成列表
